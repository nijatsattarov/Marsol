    ...
    <div className="p-4 sm:p-6 lg:p-8" data-testid="company-database-page">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => openModal()} className="bg-[#9ACD32] text-[#3D4F6F] hover:bg-[#8BC125] font-semibold" data-testid="add-lead-btn"><Plus className="w-4 h-4 mr-1" />Yeni Lead</Button>
        </div>
      </div>
